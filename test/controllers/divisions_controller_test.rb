...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { name: @division.name, user_id: @division.user_id } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { name: @division.name, user_id: @division.user_id } }
